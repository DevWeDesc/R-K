...
import GetAllClientsUseCase from "./domain/useCases/Clients/GetAllClientsUseCase";
...
export const clientsRepositories = new ClientsRepositories();
...
export const getAllClientsUseCase = new GetAllClientsUseCase(
  clientsRepositories
);
export const createClientUseCase = new CreateClientUseCase(clientsRepositories);
