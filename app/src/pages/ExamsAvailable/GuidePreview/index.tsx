...
export const GuidePreviewComponent = forwardRef<HTMLDivElement, IGuidePreview>(
  ({ isloading }, ref) => {
    const { id } = useParams<ParamsType>();
    const [modalIsOpen, setModalIsOpen] = useState(false);
    const [observations, setObservations] = useState("");

    const handleRemoveExamInGuide = async (
    ...
    if (id)
      return (
        <div
          ref={ref}
          id="guidePreview"
          className="flex flex-col items-center text-center pt-16 gap-5 w-full mx-auto mb-10"
        >
          ...
          >
            <FormGuide
              ...
              customerInformations={
                data?.data.solicitationsDetails.pet.customer
              }
              emailVeterinarian={
